...
class Like {
  ...
  crateLike(currentLikeBox) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
      ...
      // equivalent of /wp-json/uni/v1/manageLike?professorId='x'
      success: response => {
...
class MyNotes {
  ...
  // DELETE
  deleteNote(e) {
    let thisNote = jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.target).parents('li'); // selects the note that was clicked on
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
      ...
      // thisNote.data('id') will get us the <li data-id=''> number from the HTML
      type: 'DELETE',
      success: response => {
...
class Search {
  ...
  getResults() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default().getJSON(`${universityData.root_url}/wp-json/uni/v1/search?term=${this.searchField.val()}`, results => {
      this.resultDiv.html(`
                <div class="row">
                    <div class="one-third">
