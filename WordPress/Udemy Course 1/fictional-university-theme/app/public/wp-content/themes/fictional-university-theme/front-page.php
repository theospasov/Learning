        ...
        <div class="full-width-split__inner">
          ...
          <?php
            ...
            while($homepageEvents->have_posts()) {
              ...
              get_template_part('template-parts/content', 'event'); // arg1 - path to template ; arg2 - optional ! if our arg are ('template-parts/content', 'event'), WP will look for a file content-event.php in template parts; if we only have 1 arg ('template-parts/content') it will look for a file content.php
            } wp_reset_postdata();
          ?>
